...
const Auth = () => {
      ...
      if (mode === "forgot-password") {
        ...
        if (error) {
          ...
          toast({
            ...
            description: "Welcome to AiZBoostr. Redirecting to dashboard...",
          });
        }
      } else {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <Link to="/" className="flex items-center gap-2 mb-8">
            ...
            <span className="text-2xl font-bold">AiZBoostr</span>
          </Link>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative overflow-hidden bg-gradient-primary">
        ...
        <div className="relative z-10 text-center text-white p-12 max-w-lg">
          ...
          <h2 className="text-3xl font-bold mb-4">AI-Powered Advertising</h2>
          <p className="text-white/80 text-lg">
            Create stunning video ads, reach your audience, and grow your business with the power of artificial intelligence.
          </p>
        </div>
      </div>
    </div>
